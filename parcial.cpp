...
// Función auxiliar para buscar el mayor nodo del subárbol izquierdo
// Devuelve el nodo mayor y su padre mediante puntero
...
// Recorrido completo para buscar nodo y padre por nombre (recorre todo el árbol)
...
int main() {
    ...
    do {
        ...
        switch (opcion) {
            ...
            case 7:
                f1 = f2 = f3 = NULL;  // reiniciar
                encontrarTresfracs(raiz);
                if (f1) {
                    cout << "\n1. " << f1->nombre << " $" << f1->dinero  << endl;
                }
                if (f2) {
                    cout << "2. " << f2->nombre << " $" << f2->dinero   << endl;
                }
                if (f3) {
                    cout << "3. " << f3->nombre << " $" << f3->dinero   << endl;
                }
                break;
            case 8:
                eliminarNodo();
